...
import { CustomerFormProvider, useCustomerForm } from '../../contexts/CustomerFormContext';
import { MdOutlineHome, MdOutlineStorefront, MdOutlineWork } from 'react-icons/md';
  ...
  const customerTypes = [
    {
      ...
      description: 'Individual/Household customer for residential water delivery',
    ...
    },
    {
      ...
      description: 'Commercial business or company requiring water delivery services',
    ...
    },
    {
      ...
      description: 'Industrial, institutional, or other specialized water delivery',
