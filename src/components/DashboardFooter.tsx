...
export const DashboardFooter = () => {
  ...
  return (
    <div 
      className="flex justify-between p-4 pb-4 pt-4 pr-7 w-full"
      style={{ backgroundColor: colors.background.primary }}
    >
      <div className="flex items-center gap-2" style={{ color: colors.text.secondary }}>
        <span className="text-center font-poppins text-sm font-medium">
          Copyright
        </span>
        <svg
          width="24"
      ...
      <div className="flex gap-4 items-center" style={{ color: colors.text.secondary }}>
        <span 
